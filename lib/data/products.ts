export type ProductCategory = "Dehumidifiers" | "Air Purifiers" | "Mould Removal Products";
...
export const products: Product[] = [
  // ─── PRODUCT 1: Kärcher AF20 Air Purifier ─────────────────────────────────
  {
    ...
    badge: "Staff Pick",
    shortDescription:
      "Professional HEPA H13 air purifier for rooms up to 20 m². Removes allergens, mould spores, pathogens, and aerosols. Features automatic mode, night mode, and PM2.5 air quality display.",
    fullDescription:
    ...
    features: [
      "High Protect H13 Filter — removes pathogens, aerosols, mould spores, and bonds odours and chemical vapours",
    ...
    rating: 4.8,
    reviews: [
      { author: "Wanjiku Muthoni", location: "Kilimani, Nairobi", rating: 5, date: "2025-11-14", body: "I bought this for my daughter's bedroom after we discovered mould in our apartment. The difference in air quality was noticeable within two days! The PM2.5 display dropped from the red zone to green. Totally worth it — MoldGuard Kenya delivered the same day." },
      ...
      { author: "Kamau Njoroge", location: "Runda, Nairobi", rating: 5, date: "2026-01-15", body: "We have three children and were very concerned about the air quality in our home after a mould problem in the bathroom spread. This purifier has been running non-stop in the kids' playroom for two months and all three children have had fewer respiratory issues. Excellent machine." },
      ...
      { author: "Peter Kimani", location: "Thika, Kiambu", rating: 4, date: "2026-01-28", body: "Good product. I bought it after seeing mould on my bedroom ceiling. Combined with the professional treatment from MoldGuard Kenya, the air now smells completely fresh. Filter replacement seems straightforward, though I haven't done it yet after 3 months." },
      ...
      { author: "Hassan Ali", location: "Bamburi, Mombasa", rating: 5, date: "2026-02-10", body: "In Mombasa the humidity and mould spores are very high. Since getting this purifier my family's health has markedly improved — especially my elderly mother who has breathing issues. The H13 filter is very effective against the coastal mould we deal with every year." },
      { author: "Njeri Wambui", location: "Kasarani, Nairobi", rating: 5, date: "2026-02-15", body: "Cannot recommend this highly enough. I bought it when MoldGuard Kenya was treating our apartment for black mould. The technician actually recommended this specific model. After the remediation and with this running, our apartment feels like a completely different place." },
      ...
      { author: "Samuel Kiprotich", location: "Nakuru Town, Nakuru", rating: 5, date: "2026-03-01", body: "I manage several rental units and bought this for a flat that had a persistent mould problem. The tenants have been very happy since I installed it combined with MoldGuard's treatment service. Will be buying for the other units as well." },
      ...
      { author: "Michael Omondi", location: "Embakasi, Nairobi", rating: 5, date: "2026-03-08", body: "Brilliant product. I live on the ground floor and every rainy season was a nightmare for damp and mould smell. MoldGuard Kenya came and treated the mould and I got this purifier running after. The combination has completely transformed our home. Five stars." },
      { author: "Grace Mutua", location: "Ngong Road, Nairobi", rating: 5, date: "2026-03-12", body: "I bought this as a gift for my parents who have had severe mould problems in their home for years. They say the air feels noticeably cleaner and fresher. My father, who has asthma, has had zero attacks since the purifier was installed two months ago. Excellent purchase." },
      ...
      { author: "Boniface Kioko", location: "Machakos, Machakos", rating: 5, date: "2026-02-28", body: "Solid product. I bought it for my bedroom after seeing black mould in the corner near the window. The same week I had MoldGuard Kenya come and treat the mould professionally. With both measures in place the problem is completely gone and the room smells perfectly clean." },
  ...
  // ─── PRODUCT 2: Deerma CS50MW Mini Dehumidifier ───────────────────────────
  {
    ...
    rating: 4.7,
    reviews: [
      { author: "Njambi Karanja", location: "Kasarani, Nairobi", rating: 5, date: "2026-01-20", body: "This little device has saved my wardrobe completely! I live on the ground floor and my clothes were always getting that musty mould smell. I put two of these in my wardrobe and the smell is completely gone in under a week. I ordered three and saved on delivery from MoldGuard Kenya!" },
      ...
      { author: "Lydia Cherop", location: "Eldoret Town, Uasin Gishu", rating: 5, date: "2026-02-14", body: "I bought these after MoldGuard Kenya treated our house for mould. The technician actually recommended them as a maintenance measure. Brilliant little device. Easy to use and the fact that you never need to replace it makes it very cost-effective long-term." },
      ...
      { author: "Susan Wangui", location: "South B, Nairobi", rating: 5, date: "2026-03-01", body: "After years of throwing money away on disposable sachets, these reusable units are a revelation. Works perfectly in my shoes cabinet and the small bookshelf area which was always getting those white mould spots. The problem is completely under control now." },
      ...
      { author: "James Kariuki", location: "Lanet, Nakuru", rating: 5, date: "2026-03-14", body: "Bought three of these. One in my wardrobe, one in my kids' wardrobe, and one in the bathroom cabinet. All three are working great. The mould problem we had on clothing is completely solved. Modern, discreet design too — looks good even when visible." },
  ...
  // ─── PRODUCT 3: 900ml Portable Dehumidifier ───────────────────────────────
  {
    ...
    rating: 4.7,
    reviews: [
      { author: "Esther Waithera", location: "South B, Nairobi", rating: 5, date: "2025-12-10", body: "I had a serious dampness problem in my bedroom — the walls were wet and I could see black mould starting to form on the ceiling. After MoldGuard Kenya treated the mould and I placed this dehumidifier, the room has stayed perfectly dry for 3 months! The auto-shutoff is very convenient when sleeping." },
      ...
      { author: "Janet Ochieng", location: "Kisumu Town, Kisumu", rating: 5, date: "2026-01-08", body: "Bought this after our bedroom developed a mould patch on the corner wall. MoldGuard Kenya handled the mould removal and recommended this unit for ongoing humidity control. It extracts a surprising amount of water every day — visually impressive and very reassuring." },
      ...
      { author: "Florence Achieng", location: "Kisumu East, Kisumu", rating: 5, date: "2026-03-21", body: "I bought this after my rental apartment developed a serious black mould problem behind the wardrobe. MoldGuard Kenya treated the mould and recommended this for ongoing moisture control. Running it every night for a month now and the room is completely dry. Excellent product and great service." },
    ],
  },

  // ─── PRODUCT 4: MoldKill Max ──────────────────────────────────────────────
  {
    slug: "moldkill-max-mould-remover-spray",
    name: "MoldKill Max — Professional Mould Remover & Prevention Spray",
    brand: "MoldKill Max",
    category: "Mould Removal Products",
    price: 4500,
    priceDisplay: "Ksh 4,500",
    currency: "KES",
    badge: "Kenya's #1 Mould Spray",
    shortDescription:
      "Kenya's most effective mould remover and prevention spray. Kills mould spores on contact and prevents regrowth for up to 6 months. Safe for children and pets. Works on bathrooms, walls, tiles, and fabrics. Available in 500ml, 750ml, 1L & 5L.",
    fullDescription:
      "Eliminate stubborn mould and prevent its return with MoldKill Max — Kenya's trusted professional-grade mould remover and prevention spray designed specifically for our humid climate. Whether you're battling persistent bathroom mould in Mombasa's coastal humidity, fighting black mould on walls in Nairobi, or dealing with musty odours in Kisumu, MoldKill Max delivers comprehensive mould control that lasts up to 6 months. The dual-action formula doesn't just clean visible mould — it penetrates deep into porous surfaces like grout, drywall, and wood to eliminate hidden mould roots (mycelium) that cause regrowth, then creates a long-lasting protective barrier. Unlike bleach which only discolours the surface, MoldKill Max eliminates the mould at a cellular level. Family-safe: no chlorine, no harsh acids, no dangerous solvents.",
    features: [
      "Kills mould spores on contact — visible results within 24–48 hours",
      ...
      "Deep penetration formula — eliminates hidden mould roots (mycelium), not just surface stains",
      "Dual-action: kills existing mould AND creates a 6-month antimicrobial protective barrier",
    ...
    rating: 4.9,
    reviews: [
      { author: "Sarah Mwangi", location: "Nyali, Mombasa", rating: 5, date: "2025-09-12", body: "Living near the coast, bathroom mould was a constant battle. Every few weeks the black spots returned despite constant bleach cleaning. MoldKill Max was a complete game-changer — it's been 5 months since treatment and our bathroom still looks perfect. Finally a product that actually works in our humid climate!" },
      { author: "John Kamau", location: "Kilimani, Nairobi", rating: 5, date: "2025-09-20", body: "As a property manager handling 12 residential units, I've tried every mould remover available in Kenya. MoldKill Max is the only product that gives genuinely lasting results. Maintenance calls have dropped by 70% and I'm spending significantly less on repeated treatments. It's now my standard solution for all properties." },
      { author: "Grace Achieng", location: "Milimani, Kisumu", rating: 5, date: "2025-10-03", body: "My daughter's asthma attacks were getting progressively worse and our doctor suspected environmental triggers. After using MoldKill Max throughout our home, the visible mould disappeared and her breathing improved dramatically within two weeks. The peace of mind knowing our home is safe is absolutely priceless." },
      { author: "David Langat", location: "Eldoret Central, Uasin Gishu", rating: 5, date: "2025-10-11", body: "I was extremely sceptical after trying at least five other products. MoldKill Max completely exceeded my expectations. The bathroom mould that had resisted every other treatment disappeared and hasn't returned. Six months later, still completely mould-free. Highly recommended to anyone with persistent mould!" },
      { author: "Mary Wanjiku", location: "Nakuru Town, Nakuru", rating: 5, date: "2025-10-18", body: "Running a 10-room guesthouse, mould control is crucial for our reputation. MoldKill Max solved our recurring mould issues while being safe around guests. The long-lasting protection means we can focus on hospitality instead of constantly fighting mould. Best investment we've made this year." },
      { author: "Patrick Omondi", location: "Bamburi, Mombasa", rating: 5, date: "2025-10-25", body: "The coastal humidity is brutal on bathrooms and walls. I sprayed MoldKill Max on our shower tiles and grout lines in September. We are now in late October and there is still zero mould regrowth which has never happened before with any other product. Excellent — ordering the 5L bulk pack next." },
      { author: "Tabitha Njeri", location: "Kasarani, Nairobi", rating: 5, date: "2025-11-02", body: "I had black mould growing behind my wardrobe and on the bottom of the bathroom wall. MoldGuard Kenya treated the walls professionally and recommended MoldKill Max for ongoing maintenance. It works exactly as described. The musty smell is completely gone and the mould has not returned after 2 months." },
      { author: "Bernard Mutua", location: "Machakos Town, Machakos", rating: 4, date: "2025-11-09", body: "Very effective product. I used the 1L bottle on my kitchen area and bathroom. The mould visible on the grout disappeared within 2 days. I followed the instructions carefully — not wiping after application — and the protective effect has lasted well. Will be buying again for the next treatment cycle." },
      { author: "Lydia Chepchumba", location: "Kericho Town, Kericho", rating: 5, date: "2025-11-15", body: "In the tea-growing region the humidity is extremely high year-round. MoldKill Max is the first product I've found that actually holds up against this level of moisture. 3 months since applying it to our bathroom and utility room walls and there is still no sign of mould returning. Brilliant product." },
      ...
      { author: "Josephine Waweru", location: "Thika, Kiambu", rating: 4, date: "2025-12-01", body: "Good product. I had tried everything — bleach, vinegar, even painting over the mould. Nothing worked long-term until this. Went three months without any regrowth on the bathroom ceiling which is our most problematic area. The spray is easy to apply and the instructions are very clear." },
      { author: "Victor Odhiambo", location: "Kondele, Kisumu", rating: 5, date: "2025-12-08", body: "The inside of my wardrobe had developed black mould on the back wall — very stubborn. One application of MoldKill Max and within 3 days the mould was dead and gone. It's been 2 months and there is no sign of it coming back. Much better than the bleach solution I had been using." },
      ...
      { author: "Collins Kipchoge", location: "Turbo, Uasin Gishu", rating: 5, date: "2025-12-22", body: "I manage a farm house that often gets very damp from the surrounding vegetation. MoldKill Max has been the only effective solution for the moisture-related mould on our interior walls. We treated three rooms in September and are approaching 4 months with no regrowth. Impressive performance." },
      { author: "Amina Abdullahi", location: "Mombasa Island, Mombasa", rating: 5, date: "2026-01-04", body: "In old Stone Town buildings the moisture and mould problems are severe. I was not expecting MoldKill Max to work as well as it did on our very old walls. The mould has not returned for 3 months which is a record for us. Ordering in bulk for the rest of the building now." },
      { author: "Francis Gitonga", location: "Nkubu, Meru", rating: 4, date: "2026-01-12", body: "Solid mould remover. I used it in the bathroom and on a damp corner in the living room. Results were visible quickly and the protection seems to be holding very well. Only gave 4 stars because I wish the 500ml bottle were a bit less expensive, but the quality is genuinely excellent." },
      { author: "Winnie Atieno", location: "Siaya Town, Siaya", rating: 5, date: "2026-01-19", body: "Lake Victoria's humidity creates year-round mould problems in our area. MoldKill Max is the first product I've used that actually makes a meaningful lasting difference. Our bathroom walls have stayed mould-free for 3 months now. I have recommended it to everyone in my estate and several have already ordered." },
      { author: "Kevin Wafula", location: "Bungoma Town, Bungoma", rating: 4, date: "2026-01-26", body: "Works exactly as described. I applied it to our bathroom shower area which was badly affected by black mould. The mould started dying within the first day. Followed the instructions about not wiping it off and the protective effect is very real — 2 months later and still completely clear." },
      { author: "Monica Kamau", location: "Rongai, Kajiado", rating: 5, date: "2026-02-02", body: "I used this in my rental property after tenants moved out and the bathroom was badly affected. One treatment and the next tenants have been there for 2 months reporting zero mould issues. Previously I was treating that bathroom every 3 weeks with bleach. This product has saved me enormous time and money." },
      { author: "Stephen Murage", location: "Embu Town, Embu", rating: 5, date: "2026-02-09", body: "Excellent product. I had mould on the ceiling of my kitchen above the stove area which was very stubborn. MoldKill Max killed it completely within 48 hours and I can see the protective effect is holding weeks later. Very easy to apply too — just spray and leave. No complicated process." },
      { author: "Lavender Chepkorir", location: "Iten, Elgeyo Marakwet", rating: 5, date: "2026-02-16", body: "Living at altitude in a mist-covered region, mould is a permanent challenge. I've been looking for a product like this for years. MoldKill Max is outstanding — three months protection on treated areas with no regrowth at all. Ordering the 5L pack to treat the whole house comprehensively." },
      { author: "Joseph Gicheru", location: "Ruiru, Kiambu", rating: 3, date: "2026-02-20", body: "Product works well on bathroom tiles and painted surfaces. However I noticed the mould returned slightly quicker than 6 months in a very high-moisture area near my shower head where it's constantly wet. In drier spots the protection is excellent. Good product overall but manage expectations in extreme wet zones." },
      { author: "Rose Nekesa", location: "Webuye, Bungoma", rating: 5, date: "2026-02-24", body: "I discovered mould on the underside of my mattress during rainy season — a very unpleasant discovery. After treating the mattress base and surrounding wall with MoldKill Max and using a dehumidifier from MoldGuard Kenya, the problem is completely resolved. The health of my family has clearly improved as a result." },
      { author: "Brian Kirui", location: "Kapseret, Eldoret", rating: 5, date: "2026-03-02", body: "This is the real deal. I'd spent years fighting bathroom mould in Eldoret and nothing maintained results for more than a few weeks. MoldKill Max applied in early December has now maintained a completely mould-free bathroom through all of February and March — our wettest months. Absolutely outstanding." },
      { author: "Cynthia Auma", location: "Kisii Town, Kisii", rating: 4, date: "2026-03-07", body: "Works really well. The mould in our kitchen near the window has been a years-long problem and MoldKill Max has solved it. Three months since application and clean throughout. I apply it now as a preventive measure in areas that haven't yet developed mould — makes sense to protect before it starts." },
      ...
      { author: "Samuel Limo", location: "Isiolo Town, Isiolo", rating: 4, date: "2026-03-24", body: "Even in a drier region like Isiolo we get mould problems during the short rains. MoldKill Max worked very well on our bathroom and kitchen problem areas. The 500ml bottle was sufficient for our needs and was very fairly priced. Will certainly buy again when prevention treatment is due." },
      { author: "Esther Akinyi", location: "South C, Nairobi", rating: 5, date: "2026-03-25", body: "My landlord was threatening to charge me for the bathroom mould when I moved out of my old apartment. I treated the entire bathroom with MoldKill Max one week before the inspection and it looked completely clean and fresh. Saved me thousands in potential charges. But more importantly — the product really works." },
      { author: "George Kamau", location: "Westlands, Nairobi", rating: 5, date: "2026-03-26", body: "I bought MoldKill Max for my commercial office premises which had developed mould on the air conditioning wall units and surrounding surfaces. The treatment was straightforward and the results are very professional looking. Four weeks later and clean still. Highly recommend for commercial property owners and facility managers." },
      { author: "Beatrice Chebet", location: "Bomet Town, Bomet", rating: 5, date: "2026-03-26", body: "Living in a highland area with frequent mist, mould grows fast. MoldKill Max has been the only lasting solution I've found. Applied it in November and now approaching 5 months with treated surfaces still completely clean. For anyone in Kenya's highland or coastal zones this product is essential." },
      { author: "Abdul Hassan", location: "Shanzu, Mombasa", rating: 5, date: "2026-03-27", body: "At the coast the mould problem never really stops. Before MoldKill Max I was cleaning bathrooms every 2-3 weeks. Now I'm approaching 4 months since the last treatment and all surfaces remain clean. The product is safe to use around my young children which was a major concern with the harsh chemical alternatives." },
