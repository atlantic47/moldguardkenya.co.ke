      ...
      <div className="container" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "center" }}>
        ...
        <div style={{ zIndex: 1 }}>
          ...
          <h1 style={{ fontSize: "clamp(2rem, 4vw, 3.5rem)", fontWeight: 800, color: "var(--primary-dark)", lineHeight: 1.15, marginBottom: "1.25rem" }}>
            Mould Removal Solutions by MoldGuard Kenya
          </h1>
          <p style={{ fontSize: "1rem", color: "var(--text-mid)", marginBottom: "1.25rem", lineHeight: 1.7 }}>
            Discovering mould in your home is stressful. <em>Your health and property safety are our top priorities.</em> At <strong>MoldGuard Kenya</strong>, our team offers expert help to quickly fix your home.
          </p>
          <p style={{ fontSize: "1rem", color: "var(--text-mid)", marginBottom: "2rem", lineHeight: 1.7 }}>
            Effective <strong>mould removal</strong> needs precision and the right tools. We begin with a detailed <strong>mould inspection</strong> to find hidden moisture. This ensures we tackle every spore. Our experts use top techniques to remove all contamination. If you smell musty or see mould, don&apos;t delay. Let us make your home clean and healthy again.
          </p>
        ...
        <div style={{ position: "relative", height: "460px", borderRadius: "1.5rem", overflow: "hidden", boxShadow: "0 20px 60px rgba(45,80,22,0.15)" }}>
          <Image
            ...
            alt="Different services we provide as Mould removal company - MoldGuard Kenya"
            fill
